...
namespace EliteMart.UC
{
    public partial class CreateNhapHangUC : UserControl
    {
        ...
        private void OpenNewNhapHangForm()
        {
            CreateNhapHangUC createNhapHangUC = new CreateNhapHangUC(); // Tạo một thể hiện mới của form nhập hàng
                                                                        // Đặt nó vào vị trí hiển thị hoặc thêm vào một container tùy thuộc vào yêu cầu của bạn
            createNhapHangUC.Dock = DockStyle.Fill;
            this.Controls.Add(createNhapHangUC); // Thêm vào container của form gốc
        }
